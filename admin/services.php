...
<body>
    <div class="admin-container">
        ...
        <div class="card">
            <h2><i class="fas fa-plus-circle" style="color: var(--neon-accent); margin-right: 10px;"></i> Add / Edit
                Service</h2>
        ...
        <div class="card">
            <h2><i class="fas fa-list" style="color: var(--neon-accent); margin-right: 10px;"></i> Existing Services
            </h2>
                        ...
                        <?php foreach ($services as $service): ?>
                            <tr>
                                <td>
                                    ...
                                    <?php else: ?>
                                        <span style="color: #8892b0;">No Image</span>
                                    <?php endif; ?>
                                </td>
                                ...
                                <td>
                                    <button class="action-btn edit-btn"
                                        onclick='editService(<?php echo json_encode($service); ?>)'>
            ...
            <?php else: ?>
                <p style="text-align: center; padding: 20px; color: #8892b0;">No services found.</p>
            <?php endif; ?>
        </div>
    </div>
